...
/* eslint-disable no-restricted-syntax, @typescript-eslint/no-require-imports, sonarjs/different-types-comparison --
   Jest loads custom environments with `require()`; this module must stay CommonJS, and the
   `=== undefined` guards compare across realms, where the sonar rule's type reasoning does
   not hold. */
